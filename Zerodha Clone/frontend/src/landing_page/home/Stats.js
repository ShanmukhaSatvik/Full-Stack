    ...
    return ( 
        <div className='container p-3'>
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    <img src='assets/ecosystem.png' alt='Ecosystem-Image' style={{width:"130%"}}></img>
                    <div className='text-center'>
                        <a href='#' className='mx-5' style={{textDecoration:"none"}}>Explore our products <i class="fa-solid fa-long-arrow-right"></i></a>
                        <a href='#'style={{textDecoration:"none"}}>Try kite demo <i class="fa-solid fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
