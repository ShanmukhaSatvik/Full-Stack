    ...
    return (
        <div className="container">
            <div className="row text-muted">
                ...
                <div className="col">
                    <h6 className="mt-4">Securities/Commodities transaction tax</h6>
                ...
                <h6>Disclaimer</h6>
                <p className="mt-2">For Delivery based trades, a minimum of ₹0.01 will be charged per contract note. Clients who opt to receive physical contract notes will be charged ₹20 per contract note plus courier charges. Brokerage will not exceed the rates specified by SEBI and the exchanges. All statutory and regulatory charges will be levied at actuals. Brokerage is also charged on expired, exercised, and assigned options contracts. Free investments are available only for our retail individual clients. Companies, Partnerships, Trusts, and HUFs need to pay 0.1% or ₹20 (whichever is less) as delivery brokerage. A brokerage of 0.25% of the contract value will be charged for contracts where physical delivery happens. For netted off positions in physically settled contracts, a brokerage of 0.1% will be charged.</p>
                <h3 className="mt-4">Charges for account opening</h3>
                <table className="table border table-striped mt-3">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-success btn-sm">Free</button></td>
                        </tr>
                        <tr>
                ...
                <h3 className="mt-4">Charges for optional value added services</h3>
                <table className="table table-striped mt-3 mb-5 border">
                    <thead>
                        <tr>
                            <th>Service</th>
