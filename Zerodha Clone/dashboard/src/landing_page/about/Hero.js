        ...
        <div className='container'>
            ...
            <div className='row p-5 mt-5 border-top text-muted' style={{lineHeight: "1.8", fontSize: "1.1em"}}>
                ...
                <div className='col p-5'>
                    ...
                    <p>
                        And yet, we are always up to something new every day. Catch up on the latest updates on our &nbsp;<a href='#' style={{textDecoration:"none"}}>blog</a> or see what the media is &nbsp; 
                        <a href='#' style={{textDecoration:"none"}}>saying about us</a> or learn more about our business and product <a href='#' style={{textDecoration:"none"}}>philosophies</a>
                    </p>
                </div>
            </div>
        </div>
